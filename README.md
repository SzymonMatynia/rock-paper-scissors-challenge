...
### About project stack
This approach contains only basic paper, rock and scissors version. It is easy extendable to be bonus one.

Methodologies/stack:
- React.js with JavaScript only
- React Router
- SCSS + BEM contained in css modules
- Using React Context API to share state between components
- Jest for tests
---
There is idea to rewrite this project to use TypeScript.
